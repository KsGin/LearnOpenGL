...
int main() {
    ...
    do {
        ...
        if(glfwGetKey(window , GLFW_KEY_LEFT) || glfwGetKey(window , GLFW_KEY_A)){
            Model = Model * glm::rotate(glm::mat4() , glm::radians(45.0f), glm::vec3(0.0f, -1.0f, 0.0f));
        }
...
//      Model = Model * glm::rotate(glm::mat4() , glm::radians(90.0f)/100, glm::vec3(-1.0f, 0.0f, 0.0f));
//
//
        preX = curX;
        preY = curY;
